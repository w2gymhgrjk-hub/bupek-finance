...
export interface Loan {
  ...
  term: number;
  termUnit: string;
  termMonths?: number;           // legacy alias
  repaymentFrequency: RepaymentFrequency;
  processingFee: number;
  insuranceFee: number;
  totalInterest?: number;
  totalRepayable?: number;
  totalLoanAmount?: number;      // legacy alias
  ...
  approvalDate?: string;
  approvedDate?: string;         // legacy alias
  ...
  disbursedBy?: { id: string; firstName: string; lastName: string };
