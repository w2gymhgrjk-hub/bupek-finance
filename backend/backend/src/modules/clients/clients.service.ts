    ...
    return prisma.client.findUnique({
      ...
      include: {
        ...
        loans: {
          ...
          select: {
            id: true, loanNo: true, principal: true, status: true,
            disbursementDate: true, maturityDate: true, applicationDate: true,
            outstandingPrincipal: true, totalPaid: true, rejectionReason: true,
            loanProduct: { select: { name: true } },
            workflow: {
              orderBy: { stepNo: 'asc' },
              select: {
                id: true, stepNo: true, action: true, notes: true, createdAt: true, actorRole: true,
